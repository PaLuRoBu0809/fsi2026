  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipster2App.empleado.home.createOrEditLabel" data-cy="EmpleadoCreateUpdateHeading">
            <Translate contentKey="jhipster2App.empleado.home.createOrEditLabel">Create or edit a Empleado</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipster2App.empleado.nombres')}
                id="empleado-nombres"
                name="nombres"
                data-cy="nombres"
                type="text"
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.apellidos')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.correo')}
                id="empleado-correo"
                name="correo"
                data-cy="correo"
                type="text"
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.nroCelular')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.fechacontrato')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.salario')}
                id="empleado-salario"
                name="salario"
                data-cy="salario"
                type="text"
              />
              <ValidatedField
                label={translate('jhipster2App.empleado.comisionPorcentaje')}
              ...
              <ValidatedField
                ...
                label={translate('jhipster2App.empleado.inmediatosuperior')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
              ...
              <ValidatedField
                ...
                label={translate('jhipster2App.empleado.departamento')}
                type="select"
              >
                <option value="" key="0" />
                {departamentos
