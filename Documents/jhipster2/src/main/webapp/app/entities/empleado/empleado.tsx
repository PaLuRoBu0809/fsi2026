  ...
  return (
    <div>
      <h2 id="empleado-heading" data-cy="EmpleadoHeading">
        <Translate contentKey="jhipster2App.empleado.home.title">Empleados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipster2App.empleado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/empleado/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipster2App.empleado.home.createLabel">Create new Empleado</Translate>
          </Link>
        </div>
      </h2>
          ...
          {empleadoList && empleadoList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="jhipster2App.empleado.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="jhipster2App.empleado.departamento">Departamento</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipster2App.empleado.home.notFound">No Empleados found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
