  ...
  return (
    <div>
      <h2 id="direccion-heading" data-cy="DireccionHeading">
        <Translate contentKey="jhipster2App.direccion.home.title">Direccions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipster2App.direccion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/direccion/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipster2App.direccion.home.createLabel">Create new Direccion</Translate>
          </Link>
        </div>
      </h2>
        ...
        {direccionList && direccionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipster2App.direccion.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('calle')}>
                  <Translate contentKey="jhipster2App.direccion.calle">Calle</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('calle')} />
                </th>
                <th className="hand" onClick={sort('codigoPostal')}>
                  <Translate contentKey="jhipster2App.direccion.codigoPostal">Codigo Postal</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('codigoPostal')} />
                </th>
                <th className="hand" onClick={sort('ciudad')}>
                  <Translate contentKey="jhipster2App.direccion.ciudad">Ciudad</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('ciudad')} />
                </th>
                <th className="hand" onClick={sort('provincia')}>
                  <Translate contentKey="jhipster2App.direccion.provincia">Provincia</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('provincia')} />
                </th>
                <th>
                  <Translate contentKey="jhipster2App.direccion.pais">Pais</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipster2App.direccion.home.notFound">No Direccions found</Translate>
            </div>
          )
        )}
      </div>
