  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipster2App.direccion.home.createOrEditLabel" data-cy="DireccionCreateUpdateHeading">
            <Translate contentKey="jhipster2App.direccion.home.createOrEditLabel">Create or edit a Direccion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipster2App.direccion.calle')}
                id="direccion-calle"
                name="calle"
                data-cy="calle"
                type="text"
              />
              <ValidatedField
                label={translate('jhipster2App.direccion.codigoPostal')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.direccion.ciudad')}
                id="direccion-ciudad"
                name="ciudad"
                data-cy="ciudad"
                type="text"
              />
              <ValidatedField
                label={translate('jhipster2App.direccion.provincia')}
                id="direccion-provincia"
                name="provincia"
                data-cy="provincia"
                type="text"
              />
              <ValidatedField id="direccion-pais" name="pais" data-cy="pais" label={translate('jhipster2App.direccion.pais')} type="select">
                <option value="" key="0" />
                {pais
