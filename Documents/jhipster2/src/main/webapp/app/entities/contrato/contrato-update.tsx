  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipster2App.contrato.home.createOrEditLabel" data-cy="ContratoCreateUpdateHeading">
            <Translate contentKey="jhipster2App.contrato.home.createOrEditLabel">Create or edit a Contrato</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipster2App.contrato.fechaInicio')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.contrato.fechaFin')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.contrato.lenguaje')}
              ...
              >
                {idiomaValues.map(idioma => (
                  <option value={idioma} key={idioma}>
                    {translate(`jhipster2App.Idioma.${idioma}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="trabajo"
                data-cy="trabajo"
                label={translate('jhipster2App.contrato.trabajo')}
                type="select"
              >
                <option value="" key="0" />
                {trabajos
              ...
              <ValidatedField
                ...
                label={translate('jhipster2App.contrato.departamento')}
                type="select"
              >
                <option value="" key="0" />
                {departamentos
              ...
              <ValidatedField
                ...
                name="empleado"
                data-cy="empleado"
                label={translate('jhipster2App.contrato.empleado')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
