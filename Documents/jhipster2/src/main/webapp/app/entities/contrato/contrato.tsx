  ...
  return (
    <div>
      <h2 id="contrato-heading" data-cy="ContratoHeading">
        <Translate contentKey="jhipster2App.contrato.home.title">Contratoes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipster2App.contrato.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contrato/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipster2App.contrato.home.createLabel">Create new Contrato</Translate>
          </Link>
        </div>
      </h2>
          ...
          {contratoList && contratoList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="jhipster2App.contrato.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
                  <th className="hand" onClick={sort('fechaInicio')}>
                    <Translate contentKey="jhipster2App.contrato.fechaInicio">Fecha Inicio</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('fechaInicio')} />
                  </th>
                  <th className="hand" onClick={sort('fechaFin')}>
                    <Translate contentKey="jhipster2App.contrato.fechaFin">Fecha Fin</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('fechaFin')} />
                  </th>
                  <th className="hand" onClick={sort('lenguaje')}>
                    <Translate contentKey="jhipster2App.contrato.lenguaje">Lenguaje</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('lenguaje')} />
                  </th>
                  <th>
                    <Translate contentKey="jhipster2App.contrato.trabajo">Trabajo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipster2App.contrato.departamento">Departamento</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipster2App.contrato.empleado">Empleado</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {contratoList.map((contrato, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      <Translate contentKey={`jhipster2App.Idioma.${contrato.lenguaje}`} />
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipster2App.contrato.home.notFound">No Contratoes found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
