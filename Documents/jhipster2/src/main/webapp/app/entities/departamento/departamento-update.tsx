  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipster2App.departamento.home.createOrEditLabel" data-cy="DepartamentoCreateUpdateHeading">
            <Translate contentKey="jhipster2App.departamento.home.createOrEditLabel">Create or edit a Departamento</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipster2App.departamento.nombreDepartamento')}
              ...
              <ValidatedField
                ...
                name="direccion"
                data-cy="direccion"
                label={translate('jhipster2App.departamento.direccion')}
                type="select"
              >
                <option value="" key="0" />
                {direccions
