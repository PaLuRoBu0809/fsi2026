    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departamentoDetailsHeading">
          <Translate contentKey="jhipster2App.departamento.detail.title">Departamento</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipster2App.departamento.direccion">Direccion</Translate>
          </dt>
