...
export const DepartamentoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipster2App.departamento.delete.question">
        <Translate contentKey="jhipster2App.departamento.delete.question" interpolate={{ id: departamentoEntity.id }}>
