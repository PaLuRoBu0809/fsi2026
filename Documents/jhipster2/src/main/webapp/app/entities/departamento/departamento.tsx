  ...
  return (
    <div>
      <h2 id="departamento-heading" data-cy="DepartamentoHeading">
        <Translate contentKey="jhipster2App.departamento.home.title">Departamentos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipster2App.departamento.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/departamento/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipster2App.departamento.home.createLabel">Create new Departamento</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departamentoList && departamentoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipster2App.departamento.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nombreDepartamento')}>
                  <Translate contentKey="jhipster2App.departamento.nombreDepartamento">Nombre Departamento</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nombreDepartamento')} />
                </th>
                <th>
                  <Translate contentKey="jhipster2App.departamento.direccion">Direccion</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipster2App.departamento.home.notFound">No Departamentos found</Translate>
            </div>
          )
        )}
      </div>
