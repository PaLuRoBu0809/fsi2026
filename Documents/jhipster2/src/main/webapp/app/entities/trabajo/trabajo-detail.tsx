    ...
    <Row>
      <Col md="8">
        <h2 data-cy="trabajoDetailsHeading">
          <Translate contentKey="jhipster2App.trabajo.detail.title">Trabajo</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipster2App.trabajo.tarea">Tarea</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="jhipster2App.trabajo.empleado">Empleado</Translate>
          </dt>
