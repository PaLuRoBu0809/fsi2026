  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipster2App.trabajo.home.createOrEditLabel" data-cy="TrabajoCreateUpdateHeading">
            <Translate contentKey="jhipster2App.trabajo.home.createOrEditLabel">Create or edit a Trabajo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipster2App.trabajo.tituloTrabajo')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.trabajo.salarioMin')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.trabajo.salarioMax')}
              ...
              />
              <ValidatedField
                label={translate('jhipster2App.trabajo.tarea')}
                id="trabajo-tarea"
                data-cy="tarea"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="empleado"
                data-cy="empleado"
                label={translate('jhipster2App.trabajo.empleado')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
